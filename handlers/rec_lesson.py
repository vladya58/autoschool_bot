...
async def rec_menu(message: types.Message):
    ...
    await bot.delete_message(message.chat.id, message.message_id-1) if message.text == "🚘 Записаться на вождение" else None
